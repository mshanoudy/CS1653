...
public class Token implements UserToken, Serializable
{
    ...
    private SignedObject  signedObject; // SignedObject holding a copy of this token
    ...
    public Token(String issuer, String subject, List<String> groups, PrivateKey privateKey, Signature signature)
    {
        this.issuer  = issuer;
        this.subject = subject;
        this.groups  = new ArrayList<>(groups);
        ...
        try
        {
            ...
            this.signedObject = new SignedObject(b.toByteArray(), privateKey, signature);
        }
        catch (Exception e)
        {
            e.printStackTrace();
