...
public class Main extends Application
{
    ...
    private SignedObject         userToken;            // Token for this user
     ...
     */
    public void setUserToken (SignedObject userToken)
    {
     ...
     */
    public SignedObject getUserToken()
    {
        try
        {
            UserToken token = (UserToken)userToken.getObject();
            userToken = groupClient.getToken(token.getSubject());
            return userToken;
        }
        catch (Exception e)
        {
            System.out.println("PROBLEM WITH getUserToken() in Main.java");
            e.printStackTrace();
            return null;
        }
    }
    ...
    public void showMainScene() throws Exception
    {
        ...
        // Set group list
        UserToken token = (UserToken)userToken.getObject();
        groupList.addAll(token.getGroups());
